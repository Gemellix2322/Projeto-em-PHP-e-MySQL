...
<body>
    <div class="sidebar">
      ...
      <div class="main" style="background-image: url('../chill.jpg'); background-size: cover">
        <center>
            <h1>
            <B><U>Tabela de Benefícios</U></B>
            </h1>
            <p>
            <?php
            include_once "../Conexão.php";

            $sql = "select f.emp_name, p.plan_description from beneficio b, funcionario f, projeto p where (b.emp_code=f.emp_code) and (b.plan_code=p.plan_code)";
            $result = mysqli_query($conn, $sql);
            ?>
            <button><a style="color:white; text-decoration: none;" href="..\incluir\beneficios_incluir.php">Incluir</a></button>
            <button><a style="color:white; text-decoration: none;" id="pdfDownload">Relatório</a></button>
            <br>
            <table border="0">
                <thead>
                    <tr>
                        <th style="padding-right: 30px;" align="left">Nome</th>
                        <th style="padding-right: 50px;" align="right" >Projeto</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    ...
                    <tr>
                        ...
                        <td style="padding-right: 50px;" align="right"><?php echo $row[1]; ?></td>
                    </tr>
                    <?php
                    } ?>
                </tbody>
...
document.getElementById("pdfDownload").addEventListener("click", function(event) {
    ...
    fetch('../pdf/generate_pdf_beneficio.php', {
        method: 'POST',
    })
