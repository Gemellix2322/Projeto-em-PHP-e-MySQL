...
<body>
    <div class="sidebar">
      ...
      <div class="main" style="background-image: url('../chill.jpg'); background-size: cover">
        <center>
            <h1>
            <B><U>Tabela de Funcionários</U></B>
            </h1>
            <p>
            <?php
            ...
            $sql = "SELECT * FROM funcionario c LIMIT $inicio, $qnt_result_pg";
            ...
            ?>
            <button><a style="color:white; text-decoration: none;" href="..\incluir\funcionario_incluir.php">Incluir</a></button>
            <button><a style="color:white; text-decoration: none;" id="pdfDownload">Relatório</a></button>
            <table border="0">
                <thead>
                    <tr>
                        <th align="right" style="padding-left: 30px;">C&oacute;digo</th>
                        <th align="left">Nome</th>
                        <th align="left">Trabalho</th>
                ...
                <tbody>
                    ...
                    {?>
                    <tr>
                        <td style="padding-left: 50px;"><?php echo $contador; ?></td>
                        <td><?php echo $row[1]; ?></td>
                        <td><?php echo $row[2]; ?></td>
                        <td ><a href="../excluir/del_funcionario.php?c=<?php echo $row[0]; ?>"><button input="button">Excluir</button></a></td>
                    </tr>
                    <?php
                    $contador++;
                    } ?>
  ...
  rows.forEach(row => {
    row.addEventListener('dblclick', () => {
        ...
        window.location.href = '../alterar/funcionario_alterar.php?id=' + id;
    });
...
document.getElementById("pdfDownload").addEventListener("click", function(event) {
    ...
    fetch('../pdf/generate_pdf_funcionario.php', {
        method: 'POST',
    })
