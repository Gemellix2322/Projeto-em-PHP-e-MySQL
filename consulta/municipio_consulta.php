...
<body>
    <div class="sidebar">
      ...
      <div class="main" style="background-image: url('../chill.jpg'); background-size: cover">
        <center>
            ...
            ?>
            <button><a style="color:white; text-decoration: none;" href="..\incluir\municipio_incluir.php">Incluir</a></button>
            ...
            <table border="0">
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td><a href="../excluir/del_municipio.php?c=<?php echo $row[0]; ?>"><button type="button">Excluir</button></a></td>
                  </tr>
                  <?php
  ...
  rows.forEach(row => {
    row.addEventListener('dblclick', () => {
        ...
        window.location.href = '../alterar/municipio_alterar.php?id=' + id;
    });
...
document.getElementById("pdfDownload").addEventListener("click", function(event) {
    ...
    fetch('../pdf/generate_pdf_municipio.php', {
        method: 'POST',
    })
