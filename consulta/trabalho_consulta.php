...
<body>
    <div class="sidebar">
      ...
      <div class="main" style="background-image: url('../chill.jpg'); background-size: cover">
        <center>
            ...
            $sql = "SELECT * FROM trabalho c LIMIT $inicio, $qnt_result_pg";
            ...
            <table border="0">
                <thead>
                    <tr style="user-select: none;">
                        ...
                        <button><a style="color:white; text-decoration: none;" href="..\incluir\trabalho_incluir.php">Incluir</a></button>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="../excluir/del_trabalho.php?c=<?php echo $row[0]; ?>"><button input="button">Excluir</button></a></td>
                    </tr>
                    <?php
                    $contador ++;
                    } ?>
  ...
  rows.forEach(row => {
    row.addEventListener('dblclick', () => {
        ...
        window.location.href = '../alterar/trabalho_alterar.php?id=' + id;
    });
...
document.getElementById("pdfDownload").addEventListener("click", function(event) {
    ...
    fetch('../pdf/generate_pdf_trabalhos.php', {
        method: 'POST',
    })
