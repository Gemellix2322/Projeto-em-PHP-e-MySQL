...
$pagina = "<style type='text/css'>
    ...
    <div id='footer'>
        ...
        <div class='company-info'>
            ...
            E-mail: Systemhay@gmail.com | www.empresa.com.br<br>
...
$sql = "SELECT idclientes, nome, logradouro, complemento, bairro, cep, idcidade, email, idade FROM clientes";
$result = $conn->query($sql);

// Verifica e preenche a tabela com os dados dos clientes
if ($result->num_rows > 0) {
    while($row = $result->fetch_object()) {
        $endereco = "{$row->logradouro}, {$row->complemento} - {$row->bairro}";
        $tabela .= "<tr>
